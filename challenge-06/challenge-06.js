...
var teams = ["Flamengo","Palmeiras", "Santos", "Grêmio", "Atlético - PR"];
...
function showTeamPosition(numb) {
    if(teams[numb - 1] === undefined){
        return "Não temos a informação do time que está nessa posição.";
    }

    return "O time que está em " + numb + "º lugar é o " + teams[numb - 1];
}
...
console.log(showTeamPosition(4)); //O time que está em 4º lugar é o Grêmio
console.log(showTeamPosition(5)); //O time que está em 5º lugar é o Atlético - PR
...
function convertToHex(color) {
    switch(color) {
        case 'black':
            return "O hexadecimal para a cor"+ color + " é #00000.";
            break;       
        case 'white':
...
console.log(convertToHex('dark green'));
console.log(convertToHex('light green'));
