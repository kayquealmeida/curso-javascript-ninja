(function () {
    ...
    */
    ...
    function isOperatorValid(operator) {
        return !!operation[operator] //Lembrar que ele está negando a negação, fazendo com que ele retorne um valor booleano
    }
    ...
    */
    ...
    if (sum) { //Lembrar que passa sum e não sum(), porque sum já é uma função
        number1 = 90;
        number2 = 10;
    ...
    */
    ...
    operationSignal = 'o';
    var subtraction = calculator(number1, number2);
    ...
    operationSignal = 'p'
    var multiplication = calculator(number1, number2)
    ...
    operationSignal = 10
    var division = calculator(number1, number2)
    ...
    var mod = calculator(number1, number2)
