(function () {
    ...
    */
    ...
    console.log(text.replace(/Manuel Marques de Sousa/, 'Kayque Almeida do Nascimento'));
    ...
    */
    ...
    console.log(text.replace(/brasileiro/g, 'feirense'));
    ...
    */
    ...
    console.log(text.replace(/\d/g, '-'));  //\d Significa todos os dígitos
    /*
